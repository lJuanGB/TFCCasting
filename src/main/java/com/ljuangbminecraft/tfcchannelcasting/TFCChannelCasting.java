...
public class TFCChannelCasting {
    ...
    public static void registerInteractions() {
        InteractionManager.register(Ingredient.of(TFCCCTags.Items.ACCEPTED_IN_MOLD_TABLES), false,
                (stack, context) -> {
                    ...
                    if (player != null) {
                        ...
                        level.getBlockEntity(posClicked, TFCCCBlockEntities.MOLD_TABLE.get())
                                .ifPresent(mold -> mold.onRightClick(player));
                    }
    ...
    public void registerPatchouliMultiBlock() {
        ...
        final IMultiblock multiblock = api.makeMultiblock(
                ...
                'c', api.stateMatcher(TFCCCBlocks.MOLD_TABLE.get().defaultBlockState()
